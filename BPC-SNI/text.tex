...
\end{equation}
M=vyzářená energie\\
$\sigma$ Stefan-Boltzmanova kostanta - prblé je že je rozdílná pro ruzné mateiály\\
T teplota tělesa v K
\subsubsection*{termočlánkové baterie}

\includegraphics*[scale = 0.6]{img/termoclankove_baterie.png}

Infračevené žáření telesa ohřívá malé tělísko uvnitř přístroje pomocí termočlánků měříme jeho teplotou
Telísko je uchycené pouze tenkými spojí aby byla jeho telota co nejméň ovlivněna .Protože je generované U malé spojují se tremočlánky do série. 

\subsubsection*{Bolometry}

\includegraphics*[scale = 0.3]{img/bolometr.png}

Podobný přicip jako přechozí ale teplota těliska je měřena odporovým snímačem teploty. Použíají se v infrakamerách.

\subsubsection*{pyroelektrické snímače (PIR)}
Využívají pyroelektrický jev – změna spontánní polarizace při změně teploty.
použití pro měření teploty v kombinaci s bolometrem a v zabezpečovací technice.
Jinak se moc nepoužívá - má nízkou stabilitu.

\includegraphics*[scale = 0.2]{img/pyro.png}

 \subsubsection*{kvantové snímače}
 \begin{itemize}
    \item využívají vnitřního fotoelekrického jevu- doapdající zážení excitují elekrony v atomu.
    \item provední jako fotodiody, vhodně upravené aby detekovaly IR
    \item citlivější oproti ostatním 
    \item levnější
    \item omezené pásmo
 \end{itemize}
...
\end{itemize}
Extra skupinou jsou potom snímače pracující na chemickém principu- filmové dozimetry.

\subsubsection*{Plynové detektory}
2 elektrody jsou sumístěně v nejakým plynu, ionizující zážení plyn ionizuje -> satane se na chvíli vodivým. 
Na elektrody je privedeno DC předpětí pokud je plyn ionizován poteče obvodem proud.
...
Nejřive je převdeno ionizační záření na světelné - foton, světlo je potom ve fotonásobičce zesíleno. poté změřeno.

\includegraphics*[scale = 0.6]{img/scitilacni.png}


\subsubsection*{polovodičové sn. záření}
POužívá se PIN diod, dopadající zážení vyvolá vnitřní fotoelektrický jev, dioda se na chvíli otevře.
