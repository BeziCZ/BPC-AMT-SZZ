...
\subsubsection*{Určení kritických parametrů výpočtem ze známého modelu}
...
Z důvodu vzorkování se počítá, že přechodová charakteristika je zpožděná o polovinu vzorkovací periody:
\begin{figure}[H]
    \centering
